...
__TS__SourceMapTraceBack(debug.getinfo(1).short_src, {["78"] = 9,["79"] = 10,["80"] = 9,["81"] = 14,["82"] = 15,["83"] = 18,["84"] = 14,["85"] = 22,["86"] = 23,["87"] = 22});
local ____exports = {}
...
function ____exports.onStart()
    console:log("[Rotating Cube] Started for entity " .. tostring(entity.id))
end
function ____exports.onUpdate(deltaTime)
    local rotationSpeed = parameters.speed or 45
    entity.transform:rotate(0, rotationSpeed * deltaTime, 0)
end
function ____exports.onDestroy()
    console:log("[Rotating Cube] Destroyed for entity " .. tostring(entity.id))
end
return ____exports
