...
__TS__SourceMapTraceBack(debug.getinfo(1).short_src, {["77"] = 7,["78"] = 9,["79"] = 10,["80"] = 9,["81"] = 13,["82"] = 14,["83"] = 15,["84"] = 16,["85"] = 18,["86"] = 21,["87"] = 22,["88"] = 13,["89"] = 25,["90"] = 26,["91"] = 25});
local ____exports = {}
...
function ____exports.onUpdate(deltaTime)
    local speed = parameters.speed or 2
    local minScale = parameters.minScale or 0.5
    local maxScale = parameters.maxScale or 1.5
    elapsedTime = elapsedTime + deltaTime * speed
    local pulse = minScale + (maxScale - minScale) * (math.sin(elapsedTime) * 0.5 + 0.5)
